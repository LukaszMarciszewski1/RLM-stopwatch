...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e10b33c4a10f19b972bb";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Start\", function() { return Start; });\n/* harmony import */ var _Players_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Players.js */ \"./js/modules/Players.js\");\n/* harmony import */ var _Time_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Time.js */ \"./js/modules/Time.js\");\n/* harmony import */ var _Timer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Timer.js */ \"./js/modules/Timer.js\");\n// import { Players } from \"./Players\";\n\n\n\n\n\nclass Start {\n    constructor() {\n        this.timeInterval = 10000;\n        this.timeSet = 10;\n        let active = 0;\n        this.playerList = document.querySelectorAll('.name');\n\n        this.players = new _Players_js__WEBPACK_IMPORTED_MODULE_0__[\"Players\"](this.playerList, active);\n        this.time = new _Time_js__WEBPACK_IMPORTED_MODULE_1__[\"Time\"]('.time-now h3');\n        this.timer = new _Timer_js__WEBPACK_IMPORTED_MODULE_2__[\"Timer\"]('.circular span', this.timeInterval, this.timeSet);\n\n        this.clock();\n        document.querySelector('.start').addEventListener('click', this.startRace.bind(this));\n    }\n\n    clock() {\n        setInterval(this.time.getTime, 1000);\n    }\n\n    startRace() {\n        this.players.startPlayers(this.timeInterval);\n        this.timer.startTimer(this.timeSet);\n        // if(active === this.players.playerList.length){\n        //     clearInterval(this.timer.circleAnimation)\n        //     clearInterval(this.timer.stopwatchAnimation)\n        // }\n    }\n\n}\n\n//# sourceURL=webpack:///./js/modules/Start.js?");
